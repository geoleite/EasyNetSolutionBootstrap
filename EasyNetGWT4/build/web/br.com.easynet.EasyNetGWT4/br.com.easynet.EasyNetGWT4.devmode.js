...
var __gwtModuleFunction = $wnd.br_com_easynet_EasyNetGWT4;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.br.com.easynet.EasyNetGWT4=");
    idx += (13 + "br.com.easynet.EasyNetGWT4".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=br.com.easynet.EasyNetGWT4-0.js
